...
public class SampleDataConfig {
    ...
    public SampleDataConfig(UserStore userStore, TransactionStore transactionStore) {
    ...
    public void seedDemoUser() {
        User user = userStore.register("Noam", "demo@demo.com", "demo123");
